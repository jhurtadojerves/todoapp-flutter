...
android {
    namespace = "com.jhurtadojerves.todoapp_flutter"
...
gradle.taskGraph.whenReady {
    if (allTasks.any { it.name.contains("Release") } && !signingFile.exists()) {
        throw GradleException("Falta android/key.properties. Consulta BUILD_APK.md para configurar la firma de producción.")
    }
}
